...
#################################################################################################################
RESULTS_FOLDER=~/sp5_data/config/adxl_results # Path to the folder where storing the results files
SCRIPTS_FOLDER=~/sp5_data/config/scripts # Path to the folder where the graph_vibrations.py is located
